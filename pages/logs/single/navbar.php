...
<aside class="menu">
    ...
    <ul>
        ...
        <li><a href="<?php echo $edulog_root . 'pages/lesson_room';?>">Lisa ruum</a></li>
    ...
    <ul>
        ...
        <li><a id="logout" href="<?php echo $edulog_root . 'pages/login';?>">Log out (<?php echo $_SESSION['user-name']; ?>)</a></li>
        <?php if(strstr($_SERVER["SCRIPT_NAME"], 'logs')) : ?>
